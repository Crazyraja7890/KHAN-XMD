...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~MDsB1QrK#U2shbAj92SQHtr6s-dnTSW7_-CN4jzj4fVt1tltjRZs",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "971556194854",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("☠️🇽___𝐒 𝐎 𝐍 𝐔🔥ᥫ᭡፝֟آ꯭༎⎯꯭ 🍷") || "Jᴀᴡᴀᴅ TᴇᴄʜX",           // Owner's name
    DEV: process.env.DEV || "971556194854",                     // Developer's contact number
